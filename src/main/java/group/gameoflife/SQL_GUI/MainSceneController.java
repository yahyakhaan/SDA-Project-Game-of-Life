...
public class MainSceneController {
    ...
    public void saveGameInSQLDB(ActionEvent e) throws IOException {
       ...
       //SAVE GAME IMPLEMENTATION FOR SQL DATABASE
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(main.class.getResource("Save_Scene_SQL.fxml"));
    ...
    public void loadGameFromSQLDB (ActionEvent e) throws IOException
    {
        ...
        this.stop(stopGame);
        stage = (Stage)((Node)e.getSource()).getScene().getWindow();
        FXMLLoader fxmlLoader = new FXMLLoader(main.class.getResource("Load_Scene_SQL.fxml"));
